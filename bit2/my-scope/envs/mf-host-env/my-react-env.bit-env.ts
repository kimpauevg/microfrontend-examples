 ...
 */
import { moduleFederationHostransformer } from '@learnbit-react/module-federation.webpack-transformers.mf-host-transformer';
...
export class MyReactEnv extends ReactEnv {
  ...
  preview(): EnvHandler<Preview> {
    return ReactPreview.from({
      ...
      transformers: [moduleFederationHostransformer],
    });
  }
